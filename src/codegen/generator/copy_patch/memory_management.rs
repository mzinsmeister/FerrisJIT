...
use crate::codegen::{get_data_type_size, ir::{ConstValue, DataType}};

use super::CopyPatchBackend;
...
impl MemoryManagement {
    pub fn new(cp_backend: Rc<CopyPatchBackend>, arg_types: &[DataType]) -> Self {
